...
const TaskItem: React.FC<TaskItemProps> = ({ task, index, onToggle, onRemove, moveTask }) => {
  ...
  return (
    <li
      ref={ref}
      style={{ opacity }}
      className={`flex p-3 bg-white dark:bg-gray-700 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-102 hover:bg-gray-50 dark:hover:bg-gray-600 ${priorityColor[task.priority]}`}
