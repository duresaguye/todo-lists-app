...
function App() {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-200 from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white min-h-screen transition-colors duration-300">
