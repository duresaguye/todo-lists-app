...
function App() {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
     ...
     <div className="bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white min-h-screen transition-colors duration-300">
