  ...
  function App() {
    ...
    useEffect(() => {
      // Check if document is defined to avoid issues during server-side rendering or initial load
    ...
    return (
      <DndProvider backend={HTML5Backend}>
          ...
          <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white min-h-screen max-w-screen transition-colors duration-300">
