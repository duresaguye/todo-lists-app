...
function App() {
  ...
  useEffect(() => {
    ...
    if (storedDarkMode !== null) {
      ...
      applyDarkMode(parsedDarkMode); // Apply on initial load
    } else {
      applyDarkMode(false); // Ensure light mode is applied if no value in localStorage
    }
  ...
  useEffect(() => {
    ...
    applyDarkMode(darkMode); // Apply on every change of darkMode
  }, [darkMode]);
