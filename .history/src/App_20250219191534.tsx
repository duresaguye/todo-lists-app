  ...
  function App() {
    ...
    return (
      <DndProvider backend={HTML5Backend}>
          ...
          <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 text-gray-900 min-h-screen min-w-screen transition-colors duration-300">
