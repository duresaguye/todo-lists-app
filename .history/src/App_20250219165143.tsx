...
function App() {
  ...
  // Toggle dark mode using a dedicated function
  const toggleDarkMode = () => {
    setDarkMode((prev) => !prev);
  };

  // Apply dark mode class to the document root and store preference in localStorage
  useEffect(() => {
    if (darkMode) {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      {/* You can also control dark mode by toggling the `dark` class on a wrapper element */}
